...
<table class="table table-bordered text-center">
  ...
  <th class="table-header col-2">productName</th>
  <th class="table-header col-1">price</th>
  <th class="table-header col-4">description</th>
  <th class="table-header col-2">registrationDate</th>
